...
/// Representation of associated physical device
@synthesize kdcReader;

/// Identifier used when communicating with Cordova
...
//-------------------------------------------------------------------
/**
 *  Initializes instance of KoamTac scanner Cordova Plugin
 */
-(void) pluginInitialize {
    ...
    [[NSNotificationCenter defaultCenter] addObserver: self
                                             selector: @selector(kdcConnectionChanged:)
                                                 name: kdcConnectionChangedNotification
                                               object: nil];
    // Generic
    [[NSNotificationCenter defaultCenter] addObserver: self
                                             selector: @selector(kdcDataArrived:)
                                                 name: kdcDataArrivedNotification
                                               object: nil];
    // Barcode
    [[NSNotificationCenter defaultCenter] addObserver: self
                                             selector: @selector(kdcBarcodeDataArrived:)
                                                 name: kdcBarcodeDataArrivedNotification
                                               object: nil];
    // MSR
    [[NSNotificationCenter defaultCenter] addObserver: self
                                             selector: @selector(kdcMSRDataArrived:)
                                                 name: kdcMSRDataArrivedNotification
                                               object: nil];
    // NFC
    [[NSNotificationCenter defaultCenter] addObserver: self
                                             selector: @selector(kdcNFCDataArrived:)
                                                 name: kdcNFCDataArrivedNotification
                                               object: nil];
    // GPS
    [[NSNotificationCenter defaultCenter] addObserver: self
                                             selector: @selector(kdcGPSDataArrived:)
                                                 name: kdcGPSDataArrivedNotification
                                               object: nil];
...
/**
 *  Kills all bluetooth communication threads.
 */
