...
public class KoamTacScanner extends CordovaPlugin {
  ...
  public boolean execute(final String action, final JSONArray args, final CallbackContext callbackContext) throws JSONException {
    ...
    else if (CMD_DISABLE.equals(action)) {
      disable();
      return true;
    }
    else if (CMD_TRIGGER.equals(action)) {
      trigger();
      return true;
    }
...
//              mTitle.append(connectedDevice.getName());
              ...
              sendPluginResult(PluginResult.Status.OK, successMessage, true);
              break;
...
//              mTitle.setText(R.string.title_not_connected);
        ...
        case BluetoothChatService.MESSAGE_DISPLAY:
          ...
          String displayMessage = "{\"scan\":\"" +
            (new String(buffer, 0, msg.arg1)).trim() + "\"}";
